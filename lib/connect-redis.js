...
module.exports = function(connect){
   ...
   * @api public
   */
  RedisStore.prototype.keys = function(key, fn){
  ...
  /**
   * Attempt to expire session by the given `sid`.
   * @author GILI
   *
   * @param {String} sid
   * @param {Integer} ttl
  ...
  RedisStore.prototype.expire = function(sid, ttl, fn){
  	//console.log('EXPIRE: '+ttl)
    sid = this.prefix + sid;
    ttl = parseInt(ttl);
